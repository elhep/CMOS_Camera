...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_ports M_AXIS_0] [get_bd_intf_pins axis_combiner_0/M_AXIS]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins v_vid_in_axi4s_1/aclk]
  ...
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_1/aresetn]
