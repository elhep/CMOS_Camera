...
elaborate()
{
  xelab --relax --debug typical --mt auto -L v_vid_in_axi4s_v4_0_7 -L xil_defaultlib -L axis_infrastructure_v1_1_0 -L axis_combiner_v1_1_14 -L axis_register_slice_v1_1_15 -L axis_dwidth_converter_v1_1_14 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sensor_readout xil_defaultlib.sensor_readout xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sensor_readout -key {Behavioral:sim_1:Functional:sensor_readout} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sensor_readout.wdb xsim.dir)
